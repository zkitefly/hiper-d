...
*注：如果你的加入方是非 Windows 平台的用户，[请跳转至此](/命令行版.md#创建方操作视角)；是 Windows 平台的用户请继续往下看↓*
...
<pre><code>
键入 3 为非凭证加入，属于免费版，免费版会在运行后 30 分钟断连，此时 Hiper启动程序会自动重启 HIPer（创建方断连，需要将重新将IP重新发送给加入方，让他加入这个 IP）

或者使用凭证，使用凭证不会有上述问题，免费版的用户也可以访问你（创建方因使用凭证启动，创建方不重新启动 HIper 的情况下 IP 是不变的）
...
*注：如果你的加入方是非 Windows 平台的用户，[请跳转至此](/命令行版.md#加入方操作视角)；是 Windows 平台的用户请继续往下看↓*
...
1、让加入方使用非离线账户，及正版账户或者[外置登录账户（点此处查看详情）](https://bing.com/search?q=%E3%80%8A%E5%90%AF%E5%8A%A8%E5%99%A8%E3%80%8B%E5%A4%96%E7%BD%AE%E7%99%BB%E5%BD%95%E8%B4%A6%E6%88%B7%E9%85%8D%E7%BD%AE)
